...
**Headline result:** 14 token-pair test queries against mainnet, 8 beat
the cross-venue single-pool baseline (D1 threshold: >= 5), 8 multi-hop
...
**~25x (+248360 bps)** over the best direct-book option on either
